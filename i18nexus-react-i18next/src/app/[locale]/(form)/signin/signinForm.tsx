...
export default function SigninForm({ locale }: { locale: string }) {
  ...
  const handleSelect = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    switch (e.target.value) {
      case "ko":
        // setSelected({ value: "ko", icon: "KR" });
        // selected.current.value = "ko";
        router.push("/ko/signin");
        break;
      case "en":
        // setSelected({ value: "en", icon: "WW" });
        // selected.current.value = "en";
        router.push("/en/signin");
        break;
      case "ja":
        // setSelected({ value: "ja", icon: "JP" });
        // selected.current.value = "ja";
        router.push("/ja/signin");
        break;
    }
  };
